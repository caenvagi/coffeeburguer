            ...
            // if($_REQUEST['inlineRadioOptions'] == "INGRESO"){
                ...
                if(isset($_POST['register'])){
                    ...
                    if(strlen($_POST['fecha_movimiento']) >= 1 && strlen($_POST['usuario']) && strlen($_POST['movimiento']) && strlen($_POST['desc_movimiento']) && strlen($_POST['valor'])  && strlen($_POST['user_login'])){
                        ...
                        $consulta = "   INSERT INTO caja(fecha_movimiento, usuario, movimiento, desc_movimiento, valor_ingreso, valor_egreso, user_login, liquidado, caja_tipo) 
                                        VALUES ('$fecha','$usuario','$movimiento','$desc_movimiento','$valor_ingreso','$valor_egreso','$user_login','$liquidado','$tipo')";
