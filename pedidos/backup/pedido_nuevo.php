                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group">
                                ...
                                <form  action="pedido_mesa1.php"  method="POST">
                                    ...
                                    <a class="boton" value="1" id="btn-mesa11" name="pedido_mesa" href="pedido_mesa1.php?pedido_mesa=1" >mesa 1</a>
                                    <br>
                                    
                                    <a class="boton" value="2" id="btn-mesa21" name="pedido_mesa" href="pedido_mesa1.php?pedido_mesa=2" >mesa 2</a>
                                    <br>
                                
                                <!-- <input type="hidden" name="pedido_mesa" value="1"> -->

                                <br>
                                <input type="submit" class="boton" name="pedido_mesa" id="btn-mesa1" value="1" ></input>
                                <br>
                                <input type="submit" class="boton" name="pedido_mesa" id="btn-mesa2" value="2" ></input>
                                <br>

                                
                                    <button value="1" id="btn-mesa13" type="submit"  name="pedido_mesa"  class="btn btn-outline-dark btn-lg">
                                    ...
                                    <button value="2" id="btn-mesa23" type="submit" name="pedido_mesa" class="btn btn-outline-dark btn-lg" >
                                        <span class="material-icons">restaurant</span>
                                        &#160;&#160;&nbsp;
                                        Mesa 2
                                        &#160;&#160;&nbsp;
                                    ...
                                    <script>
                                        ...
                                        $(document).ready(function(){    
                                            $('#btn-mesa1').click(function(){ 
                                                // event.preventDefault(); 
                                                /*Captura de datos escrito en los inputs*/
                                                var mesa1 = $('#btn-mesa1').val();
                                                console.log(mesa1);
                                                /*Guardando los datos en el LocalStorage*/
                                                sessionStorage.setItem("MESA", mesa1);
                                                var mesa11 = sessionStorage.getItem("MESA");
                                        ...
                                        $(document).ready(function(){    
                                            $('#btn-mesa2').click(function(){ 
                                                // event.preventDefault();   
                                                /*Captura de datos escrito en los inputs*/
                                                var mesa2 = $('#btn-mesa2').val();
                                                console.log(mesa2);
                                                /*Guardando los datos en el LocalStorage*/
                                                sessionStorage.setItem("MESA", mesa2);                                              
                                                var mesa22 = sessionStorage.getItem("MESA");
                                                console.log(sessionStorage.getItem("MESA"));                           
                                                console.log(mesa22);  
                                            });   
                                        });
