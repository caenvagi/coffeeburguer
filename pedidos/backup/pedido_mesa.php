                                            ...
                                            <div class="container-fluid p-0 m-0">
                                                <div class="row">
                                                        ...
                                                        <button class="product_item btn btn-outline-dark mt-2 mb-0 mx-1"
                                                                ...
                                                                id="product_item" 
                                                                name="btn-pro"
                                                                value="<?php echo $id_pro?>" 
                                                                category="<?php echo $cat_nom?>"
                                                                product="<?php echo $nom_pro?>" 
                                                                precio="$&nbsp;<?php echo number_format($pre_pro, 0, ",", "."); ?>"
                                                                >
                                                                <div class="img1" >
                                        ...
                                        <div class="proditem" id="proditem">
                                            <div class="prod-item1">
                                                <div class="prod-item2">
                                                    ...
                                                    <div>
                                                        <p class="prod-nom1" id="prod-nom1"></p>
                                                        <p class="prod-nom2" ID="prod-nom2">$</p>
