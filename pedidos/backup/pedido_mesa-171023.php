...
// consultas 
     ...
     // ultimo codigo de recibo
        ...
        $query_productos1 = "   SELECT  
                                ...
                                INNER JOIN  categorias AS CA ON PR.producto_categoria=CA.categoria_id
                                INNER JOIN  pedidos AS PE ON PD.codigo_recibo_detalle=PE.codigo_recibo
                                WHERE       pedido_mesa = $valor and codigo_recibo_detalle = (SELECT MAX(codigo_recibo) from pedidos)
                                group by    detalle_producto
                                order by    categoria, producto_nombre
        ";
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-md-6 col-lg-6">
                                <div class="card">
                                    ...
                                    <script>
                                        let valor = sessionStorage.getItem("MESA");;
                                        document.getElementById("caja_valor").value = valor;
                                    </script>

                                        <?php
                                        $valor1 = $_POST["caja_valor"];
                                        echo $valor1; 
                                        // el valor
                                        ?>
                                        ...
                                        Pedido MESA:<label type="text" id="elements"></label>
                                        <br>
                                        <script>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4" >
                                                    <form method="POST" action="pedido_mesa1.php" class="m-0">
                                                        ...
                                                        <input type="hidden" name="pedido_mesa" value="0"></input>                                                        
