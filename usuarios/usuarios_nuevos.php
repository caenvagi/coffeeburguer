                    ...
                    <!-- tabla guias hoy -->
                            <div class="col-md-7">
                                <div class="card border-4 rounded-3">
                                    ...
                                    <div class="">
                                        <table id="tablita" class="table table-bordered text-center table table-responsive" class="table align-middle" style="font-size: 12px">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody id="myTable">
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        <td align="center"><a href="usuario.php?id=<?php echo $id; ?>"><?php echo $nombre; ?></a></td>
                                                        <td><?php if ($activo == "SI") 
